...
import { Bell, Check, Clock, Calendar, CheckSquare } from 'lucide-react';
                        ...
                        {MOCK_NOTIFICATIONS.map((notification) => (
                            ...
                            >
                                <div className="flex gap-3">
                                    <div className={`mt-1 w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${notification.type === 'chore' ? 'bg-orange-100 text-orange-600' :
                                            notification.type === 'calendar' ? 'bg-blue-100 text-blue-600' :
