...
**Google Calendar.** Bring selected Google calendars into MyLight with your own OAuth client. Optional owner-enabled editing supports individual appointments, with queued writes and conflict review. [Connection setup →](docs/GOOGLE_CALENDAR.md)
